...
- What about the perfect square stuff? Well, it does help but I don't think it actually does... Since I'm already doing squares, maybe yeah, I'll set to it as well.

To use it on the command line, just run it with python and as an argument type the int you want to check. By the way, it does have a function called get_newprimes that basically builds a list until the world ends while saves it as a json.
